...
static const string alignLabels[] =
{
        "right",
        "left",
        ""//end marker
...
public:
    BwtParameters()
    {
        ...
        addEntry( PARAMETER_ALIGN, "alignment", "--align", "", "Align variable length sequences right or left for processing", "right", TYPE_CHOICE, alignLabels );
#ifdef _OPENMP
